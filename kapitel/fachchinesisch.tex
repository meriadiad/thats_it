...
\begin{figure}[!h]
 	\centering
  	\includegraphics[width=\textwidth]{\imgdir/yes.jpg}
\end{figure}
	...
	%Beklagen sich manchmal über zu wenig Arbeit. Zu finden in Gebäudeteil 4 ganz unten. Aber auch wir sind immer f\"ur Fragen offen.
...
%    \item[Volkssternwarte:] Oben im physikalischen Verein, Freitags gibts da Vorträge und Sterne gucken kann man auch. Der Eingang ist übrigens an der Rückseite des alten Physikgebäudes in Bockenheim.
...
\begin{center}
    \includegraphics[width=1.00\textwidth]{\imgdir/ansehen.jpg}
\end{center}
\end{description}